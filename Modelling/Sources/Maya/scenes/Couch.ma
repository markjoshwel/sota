...
//Name: Couch.ma
//Last modified: Fri, Jul 26, 2024 04:01:17 PM
//Codeset: 1252
requires maya "2025";
...
fileInfo "UUID" "2984AEF8-432A-863E-237D-389223100C2F";
createNode transform -s -n "persp";
	...
	setAttr ".r" -type "double3" -42.338352731056446 447.3999999996837 7.0113429741762134e-14 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F215A7AE-4038-FCEE-F3BD-E1ABC2DD0952";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "08DFBB82-4326-E511-BC29-86BFA32EA84C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "42942EA1-4C5A-ABF3-E5D3-778AA98438AF";
createNode displayLayerManager -n "layerManager";
	rename -uid "08B7774B-4AD4-F760-9B50-E59C3990261A";
createNode displayLayer -n "defaultLayer";
	rename -uid "1BB26580-4D93-F37E-558D-378BCCE0831E";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D58D117F-4230-0FD5-C29C-33B57F6691BB";
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "14219C65-4751-FC47-A814-A88E73B8556E";

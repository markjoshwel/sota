...
//Name: Bedframe.ma
//Last modified: Sun, Jul 28, 2024 01:50:04 AM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "0CAB5954-4A34-9C04-4630-F99EDECDD9B7";
createNode transform -s -n "persp";
	rename -uid "BECBE092-4685-61E8-E5F2-6CBE463B8159";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -503.53713485215053 126.51789306414761 76.003498907539793 ;
	setAttr ".r" -type "double3" -23.738352729282941 -443.39999999942233 -2.7672120524544789e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "0D15DEAF-44A2-7304-5259-0DBB558BB193";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 428.26813109211173;
...
createNode transform -n "polySurface3" -p "pCube2";
	rename -uid "A7DB1A05-4CA3-1566-54D4-3EA3AD5A685C";
createNode mesh -n "polySurfaceShape3" -p "polySurface3";
	rename -uid "38E98542-456B-9799-FA71-0FB337FC7A50";
	setAttr -k off ".v";
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "polySurface4" -p "pCube2";
	rename -uid "115B7279-4EF3-8DAF-B2D4-E1A26B07784C";
createNode mesh -n "polySurfaceShape4" -p "polySurface4";
	rename -uid "E03584CA-4882-DFFF-4749-F9852DCBA136";
	setAttr -k off ".v";
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "polySurface5" -p "pCube2";
	rename -uid "783F2681-4883-664E-200F-C5B6844053AB";
createNode mesh -n "polySurfaceShape5" -p "polySurface5";
	rename -uid "C0D4966C-4B61-A244-BF4D-2AA64524B9F0";
	setAttr -k off ".v";
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "661F977B-4D53-15A0-7F36-67A3003CCD4E";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F2E6DD62-4866-81AE-EBB9-99B87C64EC8F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "0AA02B5E-4A74-2B18-F4B4-BBB261A37193";
createNode displayLayerManager -n "layerManager";
	rename -uid "8CE84D70-4FFC-2900-91AD-90822712A126";
createNode displayLayer -n "defaultLayer";
	rename -uid "83235546-4F81-C645-6BD0-279E425CA613";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "8AD12854-47B7-81FA-84CA-A6A4E80423A2";
...
createNode polyTweak -n "polyTweak4";
	...
	setAttr ".uopa" yes;
	setAttr -s 6 ".tk";
	setAttr ".tk[8]" -type "float3" 0.01047391 -0.02553682 -0.01047391 ;
	setAttr ".tk[9]" -type "float3" -0.01047391 -0.02553682 -0.01047391 ;
	setAttr ".tk[10]" -type "float3" -0.01047391 -0.02553682 0.01047391 ;
	setAttr ".tk[11]" -type "float3" 0.01047391 -0.02553682 0.01047391 ;
...
createNode polyTweak -n "polyTweak5";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[12]" -type "float3" 0 -0.10791992 0 ;
	setAttr ".tk[13]" -type "float3" 0 -0.10791992 0 ;
	setAttr ".tk[14]" -type "float3" 0 -0.10791992 0 ;
	setAttr ".tk[15]" -type "float3" 0 -0.10791992 0 ;
...
createNode polyTweak -n "polyTweak6";
	...
	setAttr ".uopa" yes;
	setAttr -s 21 ".tk";
	setAttr ".tk[16]" -type "float3" 0.16317843 0 0 ;
	setAttr ".tk[17]" -type "float3" 0.16317846 0 0 ;
	setAttr ".tk[18]" -type "float3" 0.16317843 0 0 ;
	setAttr ".tk[19]" -type "float3" 0.15976021 0 0 ;
	setAttr ".tk[20]" -type "float3" 0.15976021 0 0 ;
	setAttr ".tk[21]" -type "float3" 0.16317843 0 0 ;
	setAttr ".tk[22]" -type "float3" 0.16317843 0 0 ;
	setAttr ".tk[23]" -type "float3" 0.16317843 0 0 ;
	setAttr ".tk[24]" -type "float3" -0.16317846 0 0 ;
	setAttr ".tk[25]" -type "float3" -0.16317843 0 0 ;
	setAttr ".tk[26]" -type "float3" -0.16317846 0 0 ;
	setAttr ".tk[27]" -type "float3" -0.15976019 0 0 ;
	setAttr ".tk[28]" -type "float3" -0.15976019 0 0 ;
	setAttr ".tk[29]" -type "float3" -0.16317846 0 0 ;
	setAttr ".tk[30]" -type "float3" -0.16317846 0 0 ;
	setAttr ".tk[31]" -type "float3" -0.16317846 0 0 ;
...
createNode groupParts -n "groupParts4";
	rename -uid "5F8E4AA3-4C28-B1F5-8AC9-F3AEC72F02A2";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0]";
...
createNode groupParts -n "groupParts5";
	rename -uid "2E9DCC20-476F-CC13-3615-2288A5FD577C";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0]";
...
createNode groupParts -n "groupParts6";
	rename -uid "6CA428DD-4491-6F80-5454-A885A4769DC8";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0]";
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "EFA8B6CD-4E92-A4BB-E98A-D1BF5BC56989";

...
//Name: lift.ma
//Last modified: Sun, Aug 11, 2024 06:58:00 AM
//Codeset: 1252
requires maya "2025";
...
fileInfo "UUID" "0D62A0AA-443D-1F4F-8A9B-898741B2E756";
createNode transform -s -n "persp";
	rename -uid "B69D4E06-4617-3B00-FF16-648D543563E8";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -413.370445790026 493.26020872325296 163.48820446316495 ;
	setAttr ".r" -type "double3" 311.66164734075596 -2598.1999999999248 -1.5553134903084554e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "8639E6BB-4E60-E032-51D6-B8B55851DCD6";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 624.15107370383555;
...
createNode mesh -n "polySurfaceShape2" -p "polySurface1";
	...
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 121 ".uvst[0].uvsp[0:120]" -type "float2" 0.375 0 0.375 0.125
		 0.38749999 0.125 0.38749999 0 0.375 0.25 0.375 0.375 0.38749999 0.375 0.38749999
		 0.25 0.375 0.625 0.375 0.75 0.38749999 0.74999994 0.38749999 0.625 0.375 0.875 0.375
		 1 0.38749999 1 0.38749999 0.875 0.625 0 0.625 0.125 0.75 0.125 0.75 0 0.25 0.125
		 0.25 0 0.5675 0.25 0.5 0.25 0.5 0.375 0.5675 0.375 0.5 0.75 0.5675 0.75 0.5675 0.625
		 0.5 0.625 0.5 1 0.5675 1 0.5675 0.875 0.5 0.875 0.4325 0.5 0.4325 0.125 0.4325 0.25
		 0.4325 0.375 0.4325 0.75 0.4325 0.625 0.4325 0.875 0.61250001 0 0.61250001 0.125
		 0.625 0.375 0.625 0.25 0.61250001 0.25 0.61250001 0.375 0.61250001 0.75 0.625 0.75
		 0.625 0.625 0.61250001 0.625 0.61250001 1 0.625 1 0.625 0.875 0.61250001 0.875 0.25
		 0.25 0.375 0.22499999 0.25 0.22500001 0.375 0.5 0.375 0.52499998 0.38749999 0.52499998
		 0.38749999 0.5 0.4325 0.5 0.4325 0.52499998 0.5675 0.5 0.5 0.5 0.5 0.52499998 0.5675
		 0.52499998 0.625 0.52499998 0.625 0.5 0.61250001 0.5 0.61250001 0.52499998 0.625
		 0.22499999 0.75 0.25 0.75 0.22499999 0.61250001 0.22499999 0.5675 0.22499999 0.5
		 0.22499999 0.4325 0.22499999 0.38749999 0.22499999 0.125 0.22500001 0.125 0.25 0.1375
		 0.25 0.1375 0.22499999 0.125 0 0.125 0.125 0.1375 0.125 0.1375 0 0.37499997 0.76249993
		 0.38749996 0.76249993 0.43249997 0.76249993 0.5 0.76249993 0.5675 0.76249993 0.625
		 0.76249993 0.61249995 0.76249993 0.86249995 0.125 0.875 0.125 0.875 0 0.86249995
		 0 0.86249995 0.25 0.875 0.25 0.875 0.22500001 0.86250001 0.22500001 0.625 0.48750001
		 0.61250001 0.48750001 0.5675 0.48750001 0.5 0.48750001 0.4325 0.48750001 0.38749999
		 0.48750001 0.375 0.48750001 0.5675 0 0.5675 0.125 0.55875003 0.1997 0.55875003 0.24249999
		 0.55875003 0.148 0.5 0.74000001 0.55875003 0.648 0.44124997 0.58200002 0.44125 0.29729998
		 0.44125 0.28249997 0.5 0.26249999;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A902300D-42F5-C95C-4B99-D2A753FED6CB";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "BFC4B80F-4E74-9A90-DC36-7E9D274DF653";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "3D67CBC0-4AA0-50B6-EA2D-81A2A3F59EFE";
createNode displayLayerManager -n "layerManager";
	rename -uid "1257024B-42D3-E5C9-A5BE-6794E3B179A8";
createNode displayLayer -n "defaultLayer";
	rename -uid "74E15D65-4372-3A3F-CE8B-DCB6F696DA4E";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "60CF1EAD-45A9-DBFC-93AA-65AEACCC5F62";
...
createNode groupId -n "groupId23";
	rename -uid "3595C20B-46C9-383F-C545-74AF8E692534";
	setAttr ".ihi" 0;
createNode groupId -n "groupId24";
	rename -uid "0B95D466-40EB-29A7-DEE8-718881F14DFD";
	setAttr ".ihi" 0;
createNode groupId -n "groupId25";
	rename -uid "5B0212B9-44E2-187E-A53D-448CD31DAD2C";
	setAttr ".ihi" 0;
createNode groupId -n "groupId26";
	rename -uid "B5E9E446-4350-0C2E-6A02-DBB40CEA4320";
	setAttr ".ihi" 0;
createNode groupId -n "groupId27";
	rename -uid "C4AC8A10-43E3-0B3F-2EEE-798B3FC2B80D";
	setAttr ".ihi" 0;
createNode groupId -n "groupId28";
	rename -uid "DAC94714-4A0D-EFF6-B9CB-77880DEA97EC";
	setAttr ".ihi" 0;
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "2B7E6348-40C0-4DC5-FDFE-08A63C3E02D5";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
